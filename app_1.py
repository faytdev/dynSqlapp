...
class SQLServerCRUDApp:
    ...
    def create_widgets(self):
        ...
        ttk.Label(selection_frame, text="Database:").grid(
        ...
        self.database_combo.bind(
            "<<ComboboxSelected>>", self.on_database_selected)

        ttk.Label(selection_frame, text="Schema:").grid(
            row=0, column=2, padx=(0, 5))
        self.schema_combo = ttk.Combobox(selection_frame, state="readonly")
        self.schema_combo.grid(
        ...
        data_frame.grid(row=4, column=0, columnspan=3,
    ...
    def load_databases(self):
        ...
        try:
            ...
            messagebox.showerror(
                "Error", f"Failed to load databases:\n{str(e)}")
    ...
    def load_schemas(self):
        ...
        try:
            ...
            schemas = [row[0]
                       for row in cursor.fetchall() if not row[0].startswith("db_")]
    ...
    def load_table_structure(self):
        ...
        try:
            ...
            messagebox.showerror(
                "Error", f"Failed to load table structure:\n{str(e)}")
    ...
    def apply_filter(self):
        ...
        try:
            ...
            messagebox.showerror(
                "Filter Error", f"Failed to apply filter:\n{str(e)}")
    ...
    def add_record(self):
        ...
        if (
            ...
            messagebox.showwarning(
                "Add Record", "Please select a table first.")
            return
    ...
    def edit_record(self):
        ...
        dialog = RecordDialog(self.root, "Edit Record",
                              self.current_columns, record)
        if dialog.result:
            try:
                cursor = self.connection.cursor()
                cursor.execute(f"USE [{self.current_database}]")
    ...
    def connect_to_server(self):
        ...
        try:
            ...
            server = simpledialog.askstring(
                "Server Connection", "Enter server name:")
            if not server:
                return
    ...
    def delete_record(self):
        ...
        try:
            ...
            messagebox.showerror(
                "Error", f"Failed to delete record:\n{str(e)}")
            self.connection.rollback()
